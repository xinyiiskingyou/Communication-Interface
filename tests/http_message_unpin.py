...
# user1 sends a message in channel
@pytest.fixture
...
def test_unpin_invalid_token_channel(register_user1, user1_channel_message_id):
...
def test_unpin_invalid_token_dm(register_user1, user1_send_dm):
    user1_token = register_user1['token']
...
def test_unpin_invalid_message_id_channel(register_user1, register_user2, user1_channel_id):
    user1_token = register_user1['token']
...
def test_unpin_invalid_message_id_dm(register_user1, register_user2, user1_dm):
    user1_token = register_user1['token']
...
def test_unpin_not_pinned_channel(register_user1, user1_channel_message_id, user1_channel_id, register_user2):
    user1_token = register_user1['token']
