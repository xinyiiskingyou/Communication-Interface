...
from tests.fixture import user1_handle_str, user2_handle_str, channel1_name, dm1_name
        ...
        'notifications': [
            {
                ...
                'notification_message': f"{user1_handle_str} tagged you in {dm1_name}: {message[TAG_START:TAG_END]}"
            },
        ]
    })

def test_notifications_get_tagged_multiple(global_owner, user1_handle_str, 
register_user2, user2_handle_str, create_channel, channel1_name):
